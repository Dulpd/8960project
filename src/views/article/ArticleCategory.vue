...
const rules = {
    ...
    categoryAlias: [
        { required: true, message: 'Please enter a classification alias', trigger: 'blur' },
    ]
}
...
const deleteCategory = (row) => {
    ...
    ElMessageBox.confirm(
        'Are you sure you want to delete this category information?',
        'Warning',
        {
            confirmButtonText: 'CONFIRM',
            cancelButtonText: 'CANCCEL',
            type: 'warning',
        }
    )
        .then(async () => {
        ...
        .catch(() => {
            ElMessage({
                type: 'info',
                message: 'User cancels operation',
            })
        })
}
</script>
<template>
    <el-card class="page-container">
        ...
        <el-table :data="categorys" style="width: 100%">
            <el-table-column label="Order Number" width="130" type="index"> </el-table-column>
        ...
        <el-dialog v-model="dialogVisible" :title="title" width="30%">
            <el-form :model="categoryModel" :rules="rules" label-width="150px" style="padding-right: 30px">
