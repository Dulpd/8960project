...
const handleCommand = (command)=>{
    ...
    if(command === 'logout'){
        ...
        .then(async () => {
            ...
            ElMessage({
                type: 'success',
                message: 'Login successfully logged out',
            })
    ...
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#232323"  text-color="#fff"
                ...
                <el-menu-item index="/cat/category">
                    <el-icon>
                        <Management />
                    </el-icon>
                    <span>Cat Category</span>
                </el-menu-item>
                <el-menu-item index="/cat/manage">
                    <el-icon>
                        <Promotion />
                    </el-icon>
        ...
        <el-container>
                ...
                <el-dropdown placement="bottom-end" @command="handleCommand">
                    ...
                    <template #dropdown>
                        <el-dropdown-menu>
                            ...
                            <el-dropdown-item command="resetPassword" :icon="EditPen">ResetPassword</el-dropdown-item>
            ...
            <!-- 底部区域 -->
            <el-footer>Comparative Identification Management System For Stray Cats</el-footer>
        </el-container>
    </el-container>
</template>
